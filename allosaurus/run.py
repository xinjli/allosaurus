...
from allosaurus.utils.model_utils import get_all_models, resolve_model_name
...
if __name__ == '__main__':
    ...
    parser.add_argument('-m', '--model', type=str, default='23020401', help='specify which model to use. default is to use the latest local model')
    ...
    if input_path.is_dir():
        ...
        for wav_path in wav_list:
            phones = recognizer.recognize(str(wav_path), args.lang, args.timestamp)
        ...
        # run inference
        phones = recognizer.recognize(args.input, args.lang, args.timestamp)
